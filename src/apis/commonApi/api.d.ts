...
declare namespace defs {
  export namespace commonApi {
    ...
    export class ScPageResponse<T0 = any> {
      ...
      /** data */
      data?: defs.commonApi.ScPageData<defs.commonApi.CommonProductPageResponse>;
...
declare namespace API {
  export namespace commonApi {
    ...
    export namespace common {
      ...
      /**
       * 省市区
       * /api/ctsSaaS/front/common/area
       */
      export namespace getAreas {
        export class Params {}
      ...
      export namespace getCompanyBaseInfo {
        ...
        export type Response =
          defs.commonApi.ScResponse<defs.commonApi.CompanyBaseInfo>;
        export const init: Response;
        export function request(
          params: Params,
      ...
      /**
       * 文件上传
       * /api/ctsSaaS/front/common/file/upload
       */
      export namespace uploadPicture {
        export class Params {}

        export type Response =
          defs.commonApi.ScResponse<defs.commonApi.UploadFileIinfo>;
        export const init: Response;
        export function request(
          params: Params,
        ): Promise<defs.commonApi.ScResponse<defs.commonApi.UploadFileIinfo>>;
      }
    ...
    export namespace commonProduct {
      ...
      export namespace page {
        ...
        export type Response =
          defs.commonApi.ScPageResponse<defs.commonApi.CommonProductPageResponse>;
        export const init: Response;
        export function request(
          params: Params,
        ): Promise<
