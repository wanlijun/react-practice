class AdviceReportConditionMatchInfo {
  /** 进件地址 */
  incomeUrl = '';
...
class AdviceReportConditionNotMatchInfo {
  /** 进件地址 */
  incomeUrl = '';
...
class AdviceReportNotJudgedInfo {
  /** 产品名称 */
  productName = '';
...
class UserInfoExternalResponse {
  /** 是否展示银行版 */
  bankVersion = false;
...
export const userApi = {
  AdviceReportConditionMatchInfo,
  AdviceReportConditionNotMatchInfo,
  AdviceReportNoMatchInfo,
  AdviceReportNotJudgedInfo,
  AdviceReportResponse,
  AdviceResponse,
  ApplyBankVersionRequest,
  BannerInfoResponse,
  ...
  ScPageResponse,
  ScResponse,
  UserBackPasswordRequest,
  UserBaseInfoResponse,
  UserBaseRequest,
  UserInfoExternalResponse,
