...
declare namespace defs {
  ...
  export class AdviceReportConditionNotMatchInfo {
    ...
    /** 不匹配原因 */
    noMatchDetail?: Array<defs.AdviceReportNoMatchInfo>;
  ...
  export class AdviceReportResponse {
    /** 条件符合 */
    conditionsMatch?: Array<defs.AdviceReportConditionMatchInfo>;

    /** 条件不符 */
    conditionsNotMatch?: Array<defs.AdviceReportConditionNotMatchInfo>;

    /** 未进行判断 */
    notJudged?: Array<defs.AdviceReportNotJudgedInfo>;
  }
  ...
  export class ScPageResponse<T0 = any> {
    ...
    /** data */
    data?: defs.ScPageData<defs.AdviceResponse>;
...
declare namespace API {
  ...
  export namespace adminCreditAdvice {
    ...
    export namespace page {
      ...
      export type Response = defs.ScPageResponse<defs.AdviceResponse>;
    ...
    export namespace info {
      ...
      export type Response = defs.ScResponse<defs.AdviceResponse>;
    ...
    export namespace report {
      ...
      export type Response = defs.ScResponse<defs.AdviceReportResponse>;
  ...
  export namespace index {
    ...
    export namespace getIndexBanner {
      ...
      export type Response = defs.ScResponse<
        defs.ScListData<defs.BannerInfoResponse>
      >;
  ...
  export namespace user {
    ...
    export namespace applyBankVersion {
      ...
      export type Response = defs.ScResponse<void>;
      ...
      export function request(
        params: Params,
        body: defs.ApplyBankVersionRequest,
        options?: any,
      ): Promise<Response>;
    }
    ...
    export namespace changePassWord {
      ...
      export function request(
        params: Params,
        body: defs.ChangePassWordRequest,
        options?: any,
      ): Promise<Response>;
    }
    ...
    export namespace consumptionPage {
      ...
      export type Response = defs.ScPageResponse<defs.ConsumeRecordResponse>;
    ...
    export namespace consumptionTotal {
      ...
      export type Response = defs.ScResponse<number>;
    ...
    export namespace information {
      ...
      export type Response = defs.ScResponse<defs.UserBaseInfoResponse>;
    ...
    export namespace loginByCode {
      ...
      export function request(
        params: Params,
        body: defs.UserLoginCodeRequest,
        options?: any,
      ): Promise<Response>;
    }
    ...
    export namespace payPage {
      ...
      export type Response = defs.ScPageResponse<defs.RechargeRecordResponse>;
    ...
    export namespace restPwd {
      ...
      export function request(
        params: Params,
        body: defs.UserBackPasswordRequest,
        options?: any,
      ): Promise<Response>;
    }
  }
  ...
  export namespace userExternal {
    ...
    export namespace information {
      ...
      export type Response = defs.ScResponse<defs.UserInfoExternalResponse>;
  ...
  export namespace watermark {
    ...
    export namespace getContent {
      ...
      export type Response = defs.ScResponse<defs.WatermarkResponse>;
